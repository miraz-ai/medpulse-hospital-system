/**
 * MedPulse Admin – Dashboard View Script
 * Handles: pending user approval/rejection actions, sidebar/KPI counter sync.
 * Depends on: showToast() defined in admin_sidebar.php
 */
document.addEventListener('DOMContentLoaded', () => {

  // ------------------------------------------------------------------
  // executeAdminAction — approve / reject / suspend / activate a user
  // Called by inline onclick handlers on the pending-queue table rows.
  // ------------------------------------------------------------------
  ...
  // ------------------------------------------------------------------
  // syncPendingCounters — keeps header badge, sidebar badge, and KPI
  // cards in sync after row removal without a full page reload.
  // ------------------------------------------------------------------
